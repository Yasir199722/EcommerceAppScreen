...
import 'package:ecom_application/screens/categories.dart';
import 'package:ecom_application/screens/drawer.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<CategoriesModel> categoryItems = [
    CategoriesModel(
        icon: "assets/clothes.png", title: "Clothing", itemLength: 20),
    CategoriesModel(
        icon: "assets/brushbasket.png", title: "HouseHolds", itemLength: 10),
    CategoriesModel(
        icon: "assets/plugin.png", title: "Electronics", itemLength: 5),
    CategoriesModel(
        icon: "assets/moreoptions.png", title: "Others", itemLength: 50)
  ];
